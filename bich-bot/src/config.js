...
const config = {
  ...
  zalo: {
    ...
    // Bỏ qua process.env.ADMIN_ZALO_ID bị sai trên HF, fix cứng luôn ID của anh Cường
    adminId: '690136550523054881,6114894381239760462',
    // Số điện thoại trợ lý anh Cường
    assistantPhone: process.env.ASSISTANT_PHONE || '0944703139',
  },

  // Notification Settings
  notification: {
    adminUpdateSchedule: process.env.ADMIN_UPDATE_SCHEDULE || '0 20 * * *',
  },

  // Video Creator (OPC)
  videoCreator: {
    pexelsApiKey: process.env.PEXELS_API_KEY,
    fptApiKey: process.env.FPT_AI_KEY,
  },

  // Telegram Notification (Skill 03, 04, 08, 09)
  telegram: {
  ...
  ai: {
    ...
    contentCreatorMode: process.env.CONTENT_CREATOR_MODE || 'static', // 'static' hoặc 'ai'
  },
