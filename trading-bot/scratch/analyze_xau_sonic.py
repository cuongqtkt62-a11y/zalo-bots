...
async def analyze():
    ...
    symbol = "XAU/USDT:USDT" # Gold Futures on Binance (or mapped by exchange)
    print("==================================================")
    print("🔍 PHÂN TÍCH XAU/USDT THEO HỆ THỐNG VSA × ICT × SONIC R")
    print("==================================================")
    ...
    try:
        ...
        print(f"📊 Open Interest: {oi:,.2f} XAU")
        print("-" * 50)
